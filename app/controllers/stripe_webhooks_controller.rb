...
if MAP_COD_LUNA_2425.key?(produs.cod)
  ...
  def creaza_factura(payment_intent)
    ...
    if ![
      ...
      "cod214", "cod215", "cod216", "cod217", "cod218", "cod219", "cod220", "cod221", "cod222", "cod223", "cod224","cod234",
       "cod235", "cod236", "cod237", "cod238", "cod242", "cod243", "cod245", "cod246", "cod306",
       "cod307","cod308", "cod315","cod316","cod317","cod365","cod366","cod367"
    ].include?(produs.cod)
