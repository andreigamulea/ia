...
patch 'listacanal3s/:id', to: 'listacanal3s#update', as: :update_listacanal3
  ...
  get 'videos/:id/myvideo28', to: 'videos#myvideo28', as: 'myvideo28'
...
post '/stripe-webhooks', to: 'stripe_webhooks#create'
 ...
 get 'detaliifacturares/:id/edit1', to: 'detaliifacturares#edit1', as: 'detaliifacturare_edit1'
  ...
  get '/export_to_xlsx_plata_psihofonoterapie/export', to: 'paginisites#export_to_xlsx_plata_psihofonoterapie', as: 'export_to_xlsx_plata_psihofonoterapie'
