class VideosController < ApplicationController
  ...
  def tayt12
    ...
    elsif !@has_access_cursuri && !@has_access_cursuri2 #a cumparat in 2023 tabara fara nici o parte digitala
      @prod_tayt12a = Prod.where(cod: ['cod54', 'cod64'], status: 'activ').order(:cod)
    elsif @has_access_cursuri && !@has_access_cursuri2 #a cumparat in 2023 tabara doar cu p1 digitala activa inca
      @prod_tayt12a = Prod.where(cod: 'cod64', status: 'activ').order(:cod)
    elsif !@has_access_cursuri && @has_access_cursuri2 #a cumparat in 2023 tabara doar cu p2 digitala activa inca
      @prod_tayt12a = Prod.where(cod: 'cod54', status: 'activ').order(:cod)
    elsif @has_access_cursuri && @has_access_cursuri2  #a cumparat in 2023 tabara  cu p1 si p2 digitale activa inca
