...
Rails.application.configure do
  ...
  Rails.application.routes.default_url_options[:host] = 'ayushcell.ro'
  ...
  # and those relying on copy on write to perform beter.
  ...
  if ENV["RAILS_LOG_TO_STDOUT"].present?
    logger = ActiveSupport::Logger.new("log/production.log", shift_age: 2, shift_size: 10 * 1024 * 1024) # Max 10MB
